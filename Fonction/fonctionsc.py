...
def recup_scores():
    ...
    if os.path.exists(donneesc.nom_fichier_scores): # Le fichier existe
        # On le récupère
        fichier_scores = open(donneesc.nom_fichier_scores, "rb")
...
def enregistrer_scores(scores):
    ...
    fichier_scores = open(donneesc.nom_fichier_scores, "wb") # On écrase les anciens scores
...
def choisir_mot():
    ...
    return choice(donneesc.liste_mots)
